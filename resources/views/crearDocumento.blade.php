...
<div id="wizard" class="form_wizard wizard_horizontal">
  <ul class="wizard_steps anchor">
    <li>
      <a href="#step-1"
        ...
        <span class="step_descr">
          <small>Indicar empresa deudora</small>
        </span>
      </a>
    </li>
    <li>
    ...
    <li>
      <a href="#step-3"
        ...
        <span class="step_descr">
          <small>Descripcion del<br>documento adeudado</small>
        </span>
      </a>
    </li>
     <li>
      <a href="#step-4"
        ...
        <span class="step_descr">
          <small>Confirmar Informacion</small>
        </span>
      </a>
    </li>
  </ul>
  ...
  <div class="stepContainer" style="height: 282px;">
    <form class="form-horizontal form-label-left" method="POST">
      ...
      <div id="step-1" class="content" @if($etapa!=1) style="display: none;" @endif>
      ...
      <div id="step-2" class="content" @if($etapa!=2) style="display: none;" @endif>
      ...
      <div id="step-3" class="content" @if($etapa!=3) style="display: none;" @endif>
      ...
      <div id="step-4" class="content" @if($etapa!=4) style="display: none;" @endif>
